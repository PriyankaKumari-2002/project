...
class PulseMonitor(object):
    ...
    def __init__(self):
       ...
       # dpath = cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml")
        #if not os.path.exists(dpath):
           # print("Cascade file not present!")
        self.face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades+dpath)
    ...
    def run(self):
        ...
        self.draw_rect(self.face_rect, col=(255, 0, 255))
        x, y, w, h = self.face_rect
