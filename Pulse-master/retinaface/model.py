...
def load_model(model, pretrained_path, load_to_cpu):
    print('Loading image_rec improved model from {}'.format(pretrained_path))
    if load_to_cpu:
    ...
    while True:
        ...
        if True:
            for b in dets:
                ...
                cv2.circle(img_raw, (foreheadx, foreheady), 1, (0, 255, 255), 4) # right mouth
                ...
                cv2.rectangle(img_raw, forehead[0], forehead[1], (255,0, 255), 2)
